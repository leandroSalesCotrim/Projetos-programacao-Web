        ...
        <div class="corpo">
            <div class="detalhe">
                ...
                <div class="meioDetalhe">
                    <h4 class="meioDetalhetTxt">CADASTRO</h4>
                </div>
            ...
            <form class="tamanhoLogin" action="cadastrar-cliente.php" method="post">
                    <h5>CADASTRE-SE</h5>
                    <div class="form-group">
                    <label for="exampleInputEmail1">Email</label>
                    <input type="email" class="form-control" name='txtemail' placeholder="meuemail@email.com">
                    <label>Nome Completo</label>
                    <input class="form-control" type="text" name='txtnome'>
                    <label>CPF</label>
                    <input class="form-control" type="text" name='txtcpf'>
                    <label>RG</label>
                    <input class="form-control" type="text" name='txtrg'>
