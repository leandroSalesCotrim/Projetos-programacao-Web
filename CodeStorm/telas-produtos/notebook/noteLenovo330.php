        ...
        <div class="corpo">
            <div class="detalhe">
                ...
                <div class="meioDetalhe">
                    <h4 class="meioDetalhetTxt">LENOVO IDEAPAD 330</h4>
                </div>
                <div class="imgDetalhe2">
                    <img class="imgD"src="../../../CodeStorm/img/detalhe/detalheD.png">
                </div>
            </div>
        <h2>NOTEBOOK LENOVO CORE I3-7020U 4GB 1TB TELA 15.6" WINDOWS 10 IDEAPAD 330</h2>
        <div class="produto">
            <div class="imgProduto">
                <img class="imageProduto" src="../../../CodeStorm/img/notebook/lenovo330.png">
            </div>
            ...
            <table class="table table-striped">
              <thead>
                <tr>
                    ...
                    <td>Intel Core I3-7020U 2.3Ghz</td>
                </tr>
              </thead>
                <tr>
