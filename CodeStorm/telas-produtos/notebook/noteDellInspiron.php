        ...
        <div class="corpo">
            <div class="detalhe">
                ...
                <div class="meioDetalhe">
                    <h4 class="meioDetalhetTxt">INSPIRON</h4>
                </div>
                <div class="imgDetalhe2">
                    <img class="imgD"src="../../../CodeStorm/img/detalhe/detalheD.png">
                </div>
            </div>
        <h2>NOTEBOOK DELL PENTIUM GOLD 4GB 500GB TELA 15.6" WINDOWS 10 INSPIRON</h2>
        <div class="produto">
            <div class="imgProduto">
                <img class="imageProduto" src="../../../CodeStorm/img/notebook/dell15.png">
            </div>
