    ...
    <body>
        <header id = "nav">
            ...
            <div id = "navDown">
                ...
                <div id = "linkTop">
                <a href = "../../../CodeStorm/index.php" id = "link"><h1 id = "linkTxt">Inicio</h1></a>
                ...
                <div id = "linkDown">
                <a href = "../../../CodeStorm/pecas.php" id = "link"><h1 id = "linkTxt2">Peças</h1></a>
                <a href = "../../../CodeStorm/perifericos.php" id = "link"><h1 id = "linkTxt2">Periféricos</h1></a>
                <a href = "../../../CodeStorm/computador.php" id = "link"><h1 id = "linkTxt2">Computador</h1></a>
                <a href = "../../../CodeStorm/notebook.php" id = "link"><h1 id = "linkTxt2">Notebook</h1></a>
                </div>
            </div>
        </header>
        <div class="corpo">
            <div class="detalhe">
                ...
                <div class="meioDetalhe">
                    <h4 class="meioDetalhetTxt">ODYSSEY</h4>
                </div>
                <div class="imgDetalhe2">
                    <img class="imgD"src="../../../CodeStorm/img/detalhe/detalheD.png">
                </div>
            </div>
        <h2>NOTEBOOK GAMER SAMSUNG NVIDIA GFORCE GTX1650 CORE I5-930H 8GB 1TB TELA FULL HD 15.6" WIN10 ODYSSEY</h2>
        <div class="produto">
            <div class="imgProduto">
                <img class="imageProduto" src="../../../CodeStorm/img/notebook/samsungOdysseiGamer.png">
            </div>
            <div class="descProduto">
                <div class="diminuir">
                    ...
                    <hr>
                    <button class="comprar" type="reset">COMPRAR</button>
                </div>
            </div>
        </div>
        <br>
            ...
            <table class="table table-striped">
              <thead>
                <tr>
                    ...
                    <td>Intel Core I5-9300h 2.40Ghz</td>
                </tr>
              </thead>
                <tr>
              ...
              <tbody>
                <tr>
                  ...
                  <td>NVidia GeForce GTX1650 4GB</td>
                </tr>
                <tr>
                  <th scope="row">BATERIA</th>
                  <td>4 células 54wh</td>
                </tr>
                <tr>
                  <th scope="row">RAM</th>
                  <td>8GB ddr4</td>
