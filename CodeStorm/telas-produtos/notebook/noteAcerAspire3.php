<html>
    <head>
            <meta charset = "utf-8">
            <title>Notebook Acer Aspire</title>
        ...
        <div class="corpo">
            <div class="detalhe">
                ...
                <div class="meioDetalhe">
                    <h4 class="meioDetalhetTxt">ACER ASPIRE 3</h4>
                </div>
                <div class="imgDetalhe2">
                    <img class="imgD"src="../../../CodeStorm/img/detalhe/detalheD.png">
                </div>
            </div>
        <h2>NOTEBOOK ACER PENTIUM GOLD 4GB 500GB TELA 15.6" WINDOWS 10 ASPIRE 3</h2>
        <div class="produto">
            <div class="imgProduto">
                <img class="imageProduto" src="../../../CodeStorm/img/notebook/acerAspire3.png">
            </div>
            ...
            <table class="table table-striped">
              <thead>
                <tr>
                    ...
                    <td>Intel Pentium Gold 2.3Ghz</td>
                </tr>
              </thead>
                <tr>
              ...
              <tbody>
                <tr>
                  ...
                  <td>Intel HD Graphics 610</td>
                </tr>
                <tr>
                  <th scope="row">BATERIA</th>
                  <td>3 células 42wh</td>
                </tr>
                <tr>
                  <th scope="row">RAM</th>
                  <td>4GB ddr4</td>
