        ...
        <div class="corpo">
            <div class="detalhe">
                ...
                <div class="meioDetalhe">
                    <h4 class="meioDetalhetTxt">ROG STRIX</h4>
                </div>
                <div class="imgDetalhe2">
                    <img class="imgD"src="../../../CodeStorm/img/detalhe/detalheD.png">
                </div>
            </div>
        <h2>NOTEBOOK GAMER ASUS ROG STRIX G </h2>
        <div class="produto">
            <div class="imgProduto">
                <img class="imageProduto" src="../../../CodeStorm/img/notebook/asusRogStrixG.png">
            </div>
            ...
            <table class="table table-striped">
              ...
              <tbody>
                <tr>
                  ...
                  <td>NVidia GTX MX280</td>
                </tr>
                <tr>
                  <th scope="row">BATERIA</th>
                  <td>3 células 2.600mah</td>
                </tr>
                <tr>
                  <th scope="row">RAM</th>
                  <td>8GB ddr4</td>
