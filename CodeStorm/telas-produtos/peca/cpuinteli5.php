<html>
    <head>
            <meta charset = "utf-8">
            <title>Processador Intel Core I5</title>
        ...
        <div class="corpo">
            <div class="detalhe">
                ...
                <div class="meioDetalhe">
                    <h4 class="meioDetalhetTxt">PROCESSADOR INTEL CORE I5</h4>
                </div>
                <div class="imgDetalhe2">
                    <img class="imgD"src="../../../CodeStorm/img/detalhe/detalheD.png">
                </div>
            </div>
            <h2>PROCESSADOR INTEL CORE I5 7400 KABY LAKE 6MB 3.0GHZ LGA1151</h2>
            <div class="produto">
                <div class="imgProduto">
                    <img class="imageProduto" src="../../../CodeStorm/img/pecas/cpu/core5.png">
                </div>
