<html>
    <head>
            <meta charset = "utf-8">
            <title>Placa Mãe Gigabyte</title>
        ...
        <div class="corpo">
            <div class="detalhe">
                ...
                <div class="meioDetalhe">
                    <h4 class="meioDetalhetTxt">PLACA MÃE GIGABYTE</h4>
                </div>
                <div class="imgDetalhe2">
                    <img class="imgD"src="../../../CodeStorm/img/detalhe/detalheD.png">
                </div>
            </div>
            <h2>PLACA MÃE GIGABYTE INTEL X299X AORUS MASTER DDR4 LGA2066</h2>
            <div class="produto">
                <div class="imgProduto">
                    <img class="imageProduto" src="../../../CodeStorm/img/pecas/placa/gigabytex299.png">
                </div>
            ...
            <div class="especificacoes">
                ...
                <table class="table table-striped">
                  <thead>
                    ...
                    <tr>
                      <th scope="row">GPU</th>
                      <td>INTEGRADO INTEL</td>
                    </tr>
                    <tr>
                      <th scope="row">MEMÓRIA</th>
                      <td>DDR4 8 SLOTS ATÉ 256GB</td>
                    </tr>
                </table>
                </center>
            </div>
