<html>
    <head>
            <meta charset = "utf-8">
            <title>PLACA DE VIDEO Gigabyte</title>
    ...
    <body>
        <div class="corpo">
            ...
            <h2>PLACA DE VÍDEO GIGABYTE GEFORCE NVIDIA GT710 2GB 64bits</h2>
            <div class="produto">
                <div class="imgProduto">
                    <img class="imageProduto" src="../../../CodeStorm/img/pecas/placaDeVideo/gigabyte2.png">
                </div>
