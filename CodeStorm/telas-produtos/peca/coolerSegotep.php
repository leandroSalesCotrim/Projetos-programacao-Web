        ...
        <div class="corpo">
            <div class="detalhe">
                ...
                <div class="meioDetalhe">
                    <h4 class="meioDetalhetTxt">COOLER SEGOTEP</h4>
                </div>
                <div class="imgDetalhe2">
                    <img class="imgD"src="../../../CodeStorm/img/detalhe/detalheD.png">
                </div>
            </div>
            <h2>COOLER FAN GAMING LIGHTING RGB 12 SEGOTEP</h2>
            <div class="produto">
                <div class="imgProduto">
                    <img class="imageProduto" src="../../../CodeStorm/img/pecas/cooler/segotep.png">
                </div>
            ...
            <div class="especificacoes">
                ...
                <table class="table table-striped">
                  <thead>
                    ...
                    <tr>
                      <th scope="row">LED</th>
                      <td>RGB12 LUMINOSO</td>
                    </tr>
                    <tr>
                      <th scope="row">TAXA DE RUIDO</th>
                      <td>24DB A</td>
                    </tr>
                </table>
                </center>
