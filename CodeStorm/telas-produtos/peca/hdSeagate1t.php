<html>
    <head>
            <meta charset = "utf-8">
            <title>HD Seagate Expansion</title>
        ...
        <div class="corpo">
            <div class="detalhe">
                ...
                <div class="meioDetalhe">
                    <h4 class="meioDetalhetTxt">HD SEAGATE EXPANSION</h4>
                </div>
                <div class="imgDetalhe2">
                    <img class="imgD"src="../../../CodeStorm/img/detalhe/detalheD.png">
                </div>
            </div>
            <h2>HD Externo Portátil Seagate Expansion 1 TB USB</h2>
            <div class="produto">
                <div class="imgProduto">
                    <img class="imageProduto" src="../../../CodeStorm/img/pecas/hd/seagate1tbex.png">
                </div>
