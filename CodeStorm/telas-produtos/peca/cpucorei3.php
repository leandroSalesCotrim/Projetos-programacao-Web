<html>
    <head>
            <meta charset = "utf-8">
            <title>Processador IntelCore I3</title>
        ...
        <div class="corpo">
            <div class="detalhe">
                ...
                <div class="meioDetalhe">
                    <h4 class="meioDetalhetTxt">PROCESSADOR INTEL CORE I3</h4>
                </div>
                <div class="imgDetalhe2">
                    <img class="imgD"src="../../../CodeStorm/img/detalhe/detalheD.png">
                </div>
            </div>
            <h2>PROCESSADOR INTEL CORE I3-9100F COFFEE LAKE 6MB 3.6GHZ 4.2GHZ MAX TURBO LGA1051 SEM VIDEO</h2>
            <div class="produto">
                <div class="imgProduto">
                    <img class="imageProduto" src="../../../CodeStorm/img/pecas/cpu/core13.png">
                </div>
