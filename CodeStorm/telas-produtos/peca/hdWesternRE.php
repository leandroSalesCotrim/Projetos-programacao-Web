<html>
    <head>
            <meta charset = "utf-8">
            <title>HD Western Enterprise</title>
        ...
        <div class="corpo">
            ...
            <div class="detalhe">
                ...
                <div class="meioDetalhe">
                    <h4 class="meioDetalhetTxt">HD WESTERN RE</h4>
                </div>
                <div class="imgDetalhe2">
                    <img class="imgD"src="../../../CodeStorm/img/detalhe/detalheD.png">
                </div>
            </div>
            <h2>HD 2TB SATA3 Western Digital RE Enterprise - WD2000FYYZ (3,5pol, 6Gb/s, 7.200 RPM, 64MB Cache)</h2>
            <div class="produto">
                <div class="imgProduto">
                    <img class="imageProduto" src="../../../CodeStorm/img/pecas/hd/western2tb.png">
                </div>
