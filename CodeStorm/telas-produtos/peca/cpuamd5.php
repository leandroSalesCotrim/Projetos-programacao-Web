<html>
    <head>
            <meta charset = "utf-8">
            <title>Processador Amd Ryzen 5</title>
        ...
        <div class="corpo">
            <div class="detalhe">
                ...
                <div class="meioDetalhe">
                    <h4 class="meioDetalhetTxt">PROCESSADOR AMD RYZEN 5</h4>
                </div>
                <div class="imgDetalhe2">
                    <img class="imgD"src="../../../CodeStorm/img/detalhe/detalheD.png">
                </div>
            </div>
            <h2>PROCESSADOR AMD  RYZEN 5 2600 COOLER WRAITH STELTH CACHE 19 MB  2.4GHZ AM4</h2>
            <div class="produto">
                <div class="imgProduto">
                    <img class="imageProduto" src="../../../CodeStorm/img/pecas/cpu/ryzen5.png">
                </div>
