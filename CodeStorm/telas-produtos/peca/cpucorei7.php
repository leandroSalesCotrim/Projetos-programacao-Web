<html>
    <head>
            <meta charset = "utf-8">
            <title>Processador Intel Core I7</title>
        ...
        <div class="corpo">
            <div class="detalhe">
                ...
                <div class="meioDetalhe">
                    <h4 class="meioDetalhetTxt">PROCESSADOR INTEL CORE I7</h4>
                </div>
                <div class="imgDetalhe2">
                    <img class="imgD"src="../../../CodeStorm/img/detalhe/detalheD.png">
                </div>
            </div>
            <h2>PROCESSADOR INTEL CORE I7 9700K COFFEE LAKE REFRASH CACHE 12MB 3.6GHZ LGA1151</h2>
            <div class="produto">
                <div class="imgProduto">
                    <img class="imageProduto" src="../../../CodeStorm/img/pecas/cpu/core7.png">
                </div>
            ...
            <div class="especificacoes">
                ...
                <table class="table table-striped">
                  <thead>
                    ...
                    <tr>
                      <th scope="row">NÚCLEOS</th>
                      <td>8</td>
                    </tr>
                    <tr>
                      <th scope="row">GPU</th>
                      <td>INTEL UHD 6300</td>
                    </tr>
                </table>
                </center>
            </div>
