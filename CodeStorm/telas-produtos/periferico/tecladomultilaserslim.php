<html>
    <head>
            <meta charset = "utf-8">
            <title>Teclado Multilaser</title>
        ...
        <div class="corpo">
            <div class="detalhe">
                ...
                <div class="meioDetalhe">
                    <h4 class="meioDetalhetTxt">TECLADO MULTILASER</h4>
                </div>
                <div class="imgDetalhe2">
                    <img class="imgD"src="../../../CodeStorm/img/detalhe/detalheD.png">
                </div>
            </div>
            <h2>TECLADO MULTILASER UBS</h2>
            <div class="produto">
                <div class="imgProduto">
                    <img class="imageProduto" src="../../../CodeStorm/img/perifericos/teclados/usb-slim-multilaser.png">
                </div>
