        ...
        <div class="corpo">
            <div class="detalhe">
                ...
                <div class="meioDetalhe">
                    <h4 class="meioDetalhetTxt">TECLADO GAMEMAX</h4>
                </div>
                <div class="imgDetalhe2">
                    <img class="imgD"src="../../../CodeStorm/img/detalhe/detalheD.png">
                </div>
            </div>
            <h2>TECLADO GAMEMAX UBS GAMER</h2>
            <div class="produto">
                <div class="imgProduto">
                    <img class="imageProduto" src="../../../CodeStorm/img/perifericos/teclados/usb-gamer-iluminado-gamemax.png">
                </div>
            ...
            <div class="especificacoes">
                ...
                <table class="table table-striped">
                  <thead>
                    ...
                    <tr>
                      <th scope="row">EXTENSÃO DE CABO</th>
                      <td>1,6M</td>
                    </tr>
                    <tr>
                      <th scope="row">LED</th>
