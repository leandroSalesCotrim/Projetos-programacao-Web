        ...
        <div class="corpo">
            <div class="detalhe">
                ...
                <div class="meioDetalhe">
                    <h4 class="meioDetalhetTxt">IMPRESSORA EPSON</h4>
                </div>
                <div class="imgDetalhe2">
                    <img class="imgD"src="../../../CodeStorm/img/detalhe/detalheD.png">
                </div>
            </div>
            <h2>IMPRESSORA EPSON MULTIFUNCIONAL ECOTANK L3150</h2>
            <div class="produto">
                <div class="imgProduto">
                    <img class="imageProduto" src="../../../CodeStorm/img/perifericos/impressora/Multifuncional-epson-ecotank-L3150.png">
                </div>
            ...
            <div class="especificacoes">
                ...
                <table class="table table-striped">
                  <thead>
                    <tr>
                        <th>CONECTIVIDADE</th>
                        <td>USB WIFI-DIRECT</td>
                    </tr>
                  </thead>
                    <tr>
                      <th scope="row">RESOLUÇÃO</th>
                      <td>ATE 5760X1440DPI</td>
                    </tr>
                    <tr>
                      <th scope="row">CICLO MENSAL</th>
                      <td>7500 FOLHAS COLORIDAS</td>
                    </tr>
                </table>
                </center>
            </div>
