<html>
    <head>
            <meta charset = "utf-8">
            <title>Pendrive Multilaser</title>
        ...
        <div class="corpo">
            <div class="detalhe">
                ...
                <div class="meioDetalhe">
                    <h4 class="meioDetalhetTxt">TWIST</h4>
                </div>
                <div class="imgDetalhe2">
                    <img class="imgD"src="../../../CodeStorm/img/detalhe/detalheD.png">
                </div>
            </div>
            <h2>PENDRIVE MULTILASER TWIST 32GB</h2>
            <div class="produto">
                <div class="imgProduto">
                    <img class="imageProduto" src="../../../CodeStorm/img/perifericos/pendrive/multilaser-twist-32gb.png">
                </div>
