        ...
        <div class="corpo">
            <div class="detalhe">
                ...
                <div class="meioDetalhe">
                    <h4 class="meioDetalhetTxt">FONE RAZER</h4>
                </div>
                <div class="imgDetalhe2">
                    <img class="imgD"src="../../../CodeStorm/img/detalhe/detalheD.png">
                </div>
            </div>
            <h2>HEADPHONE RAZER GAMER </h2>
            <div class="produto">
                <div class="imgProduto">
                    <img class="imageProduto" src="../../../CodeStorm/img/perifericos/headset/gamer-razer-chroma.png">
                </div>
