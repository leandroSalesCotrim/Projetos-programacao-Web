    ...
    <body id = "body_home">
            ...
            <div class="linha13">
                    <div class="coluna">
                        <div id="card" class="card" style="width: 18rem;">
                            <img class="card-img-top" src="../CodeStorm/img/computador/carnage.png"   alt="Imagem de capa do card">
                            <div class="card-body">
                    ...
                    <div class="coluna">
                        <div id="card" class="card" style="width: 18rem;">
                            <img class="card-img-top" src="../CodeStorm/img/computador/firestorm.png"   alt="Imagem de capa do card">
                            <div class="card-body">
                    ...
                    <div class="coluna">
                        <div id="card" class="card" style="width: 18rem;">
                            <img class="card-img-top" src="../CodeStorm/img/computador/havoc.png"  alt="Imagem de capa do card">
                            <div class="card-body">
                ...
                <div class="linha14">
                    <div class="coluna">
                        <div id="card" class="card" style="width: 18rem;">
                            <img class="card-img-top" src="../CodeStorm/img/computador/nexus.png"      alt="Imagem de capa do card">
                            <div class="card-body">
                    ...
                    <div class="coluna">
                        <div id="card" class="card" style="width: 18rem;">
                            <img class="card-img-top" src="../CodeStorm/img/computador/predator.png"  alt="Imagem de capa do card">
                            <div class="card-body">
                    ...
                    <div class="coluna">
                        <div id="card" class="card" style="width: 18rem;">
                            <img class="card-img-top" src="../CodeStorm/img/computador/prime.png"  alt="Imagem de capa do card">
                            <div class="card-body">
        ...
        <section class="webcam" id="webcam">
            <div class="linha13">
                    <div class="coluna">
                        <div id="card" class="card" style="width: 18rem;">
                            <img class="card-img-top" src="../CodeStorm/img/computador/raptor.png"   alt="Imagem de capa do card">
                            <div class="card-body">
                    ...
                    <div class="coluna">
                        <div id="card" class="card" style="width: 18rem;">
                            <img class="card-img-top" src="../CodeStorm/img/computador/supernova.png"   alt="Imagem de capa do card">
                            <div class="card-body">
                    ...
                    <div class="coluna">
                        <div id="card" class="card" style="width: 18rem;">
                            <img class="card-img-top" src="../CodeStorm/img/computador/veneno.png"  alt="Imagem de capa do card">
                            <div class="card-body">
                ...
                <div class="linha14">
                    <div class="coluna">
                        <div id="card" class="card" style="width: 18rem;">
                            <img class="card-img-top" src="../CodeStorm/img/computador/ghost.png"      alt="Imagem de capa do card">
                            <div class="card-body">
